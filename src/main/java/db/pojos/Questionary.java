...
public class Questionary implements Serializable {
	...
	public Questionary(Emotion emotion, int muscle_tension, int chest_pressure, int breathing_difficulty, int shaky,
			...
			int social_interaction, int relationships, int anxiety_level, boolean treatment, boolean control, int durat,
			AnxietyLevel anxiety_experience, Emotion emotion_2, int sleep_improvement, int muscle_tension_change,
			int anxiety_level_2, int relaxation, boolean listen_more_songs, Experience song_experience,
			int relaxation_ability_change, int concentration_improvement, int panic_reduction, Energy energy_level,
			int well_being_change, boolean try_different_genres, int song_satisfaction, int stress_coping_change,
			int confidence_change, Emotion emotional_state, int enjoyment_change, int anxiety_perception_change,
			boolean recommendations, String resultado) {
		super();
	...
	public String toString() {
		return "Questionary [emotion=" + emotion + ", muscle_tension=" + muscle_tension + ", chest_pressure="
				...
				+ ", treatment=" + treatment + ", control=" + control + ", durat=" + durat + ", anxiety_experience="
				+ anxiety_experience + ", emotion_2=" + emotion_2 + ", sleep_improvement=" + sleep_improvement
				+ ", muscle_tension_change=" + muscle_tension_change + ", anxiety_level_2=" + anxiety_level_2
				+ ", relaxation=" + relaxation + ", listen_more_songs=" + listen_more_songs + ", song_experience="
				+ song_experience + ", relaxation_ability_change=" + relaxation_ability_change
