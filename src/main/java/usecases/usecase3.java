...
public class usecase3 {
	...
	public static void main(String args[]) throws IOException {
		...
		// in this usecase3 5 rules are going to be tested. Go to package rul3 and open
		// rule3.drl file. Kiesession: usecase3
		...
		// tested rules are from nº11 to nº15.
		...
		// Rule13 ==> Try listening to music to reduce the feeling of chest pressure and
		// muscle tension
