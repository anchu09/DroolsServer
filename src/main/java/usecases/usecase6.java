...
public class usecase6 {
	...
	public static void main(String args[]) throws IOException {
		...
		// in this usecase6 5 rules are going to be tested. Go to package rul6 and open
		// rule6.drl file. Kiesession: usecase6
		...
		// tested rules are from nº26 to nº30.
		...
		// Rule26 ==> Listen to relaxing music to help manage stressful and worrying
		// situations in the future
		// Rule30 ==> We recomend you to go to a therapist to talk about the stresfull
		// situations
