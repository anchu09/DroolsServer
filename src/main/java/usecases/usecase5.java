...
public static void main(String args[]) throws IOException {
	...
	//in this usecase5 5 rules are going to be tested. Go to package rul5 and open rule5.drl file. Kiesession: usecase5
	...
	//The tested attributes will  be filled with prefixed values using setters. The tested rules are from nº21 to nº25. 
