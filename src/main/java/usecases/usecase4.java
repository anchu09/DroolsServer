...
public class usecase4 {
	...
	public static void main(String args[]) throws IOException {
		...
		// in this usecase3 5 rules are going to be tested. Go to package rul4 and open
		// rule4.drl file. Kiesession: usecase4
		...
		// tested rules are from nº16 to nº20.
		...
		// Rule18 ==> Listen to music to help reduce feelings of panic or irrational
		// fear
