...
public static void main(String args[]) throws IOException {
	...
	//Rule6 ==> Experiment with different genres of music to see if there is any difference in your emotional response
	//Rule9 ==> Keep listening to relaxing music to help control your anxiety
	//Rule10 ==> Keep listening to relaxing music to improve your ability to concentrate on tasks
